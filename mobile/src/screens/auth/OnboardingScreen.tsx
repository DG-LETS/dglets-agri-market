...
const slides = [
  {
    ...
    description: 'Find verified farmers and fresh produce directly. No middlemen, fair prices, real inventory.',
    bg: Colors.green[700],
  },
  {
    id: '2',
    emoji: '🗺️',
    title: 'Smart Map\nDiscovery',
    description: 'Find the cheapest, nearest, highest-rated suppliers using our intelligent Smart Map.',
    bg: Colors.green[800],
  },
  {
    id: '3',
    emoji: '🚛',
    title: 'Integrated\nHaulage',
    description: 'Approved logistics partners bid on your delivery. Track in real-time from farm to doorstep.',
    bg: Colors.green[600],
  },
  {
    id: '4',
    emoji: '🏆',
    title: 'Earn DGR\nRewards',
    description: 'Every purchase, review and referral earns you DGR reward tokens. The more you participate, the more you earn.',
    bg: Colors.green[700],
  },
];
    ...
    <View style={[styles.container, { backgroundColor: slides[current].bg }]}>
      ...
      <View style={[styles.actions, { paddingBottom: insets.bottom + Spacing[4] }]}>
        <Button
          ...
          textStyle={{ color: isLast ? Colors.white : Colors.white }}
        />
        {!isLast && (
